    ...
    <footer className="wow fadeInUp pt-14 sm:pt-20 lg:pt-[130px]" data-wow-delay=".2s">
      <div className="px-4 xl:container">
        <div className="flex flex-wrap -mx-4">
          <div className="w-full px-4 sm:w-1/2 md:w-5/12 lg:w-3/12 xl:w-3/12">
            <div className="mb-20 max-w-[330px]">
              ...
              <p className="mb-10 text-base text-dark-text">
                Aldo Website LLC builds conversion-focused websites for service
                businesses, ecommerce brands, and agencies.
              </p>
            ...
            <div className="mb-20">
              ...
              <ul className="space-y-4">
                <li>
                  <Link
                    to="/#home"
                    className="text-base font-heading text-dark-text hover:text-primary dark:hover:text-white"
                  >
                    Home
                  </Link>
                </li>
          ...
          <div className="w-1/2 px-4 md:w-3/12 lg:w-3/12 xl:w-2/12">
            <div className="mb-20">
              <h3 className="text-2xl font-medium mb-9 font-heading text-dark dark:text-white">Explore</h3>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-5/12 lg:w-3/12 xl:w-2/12">
            <div className="mb-20">
              ...
              <div className="space-y-7">
                <div>
                  <p className="text-base font-heading text-dark-text">Project inquiries</p>
                  <a
                    href="mailto:hello@aldowebsite.com"
                    className="text-base font-heading text-dark hover:text-primary dark:text-white dark:hover:text-primary"
                  >
                    hello@aldowebsite.com
                  </a>
                </div>
                <div>
                  <p className="text-base font-heading text-dark-text">Prefer a quick call?</p>
                  <Link
                    to="/#support"
                    className="text-base font-heading text-dark hover:text-primary dark:text-white dark:hover:text-primary"
                  >
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-5/12 lg:w-5/12 xl:w-3/12">
            <div className="mb-20">
              ...
              <p className="mb-6 text-base font-heading text-dark-text">
                Get occasional updates and practical web tips.
              </p>
          ...
          <div className="flex flex-wrap py-5 -mx-4 md:py-7">
            <div className="w-full px-4 md:w-1/2 lg:w-2/3">
              <div className="mb-5 flex items-center justify-center space-x-5 border-b pb-5 dark:border-[#2E333D] md:mb-0 md:justify-start md:border-0 md:pb-0">
                <Link to="/#home" className="text-base font-heading text-dark-text hover:text-primary">
                  Home
                </Link>
                <Link to="/#features" className="text-base font-heading text-dark-text hover:text-primary">
                  Services
                </Link>
                <Link to="/#support" className="text-base font-heading text-dark-text hover:text-primary">
                  Contact
                </Link>
              </div>
            </div>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div>
                <p className="text-base text-center font-heading text-dark-text lg:text-right">
                  © 2025 Aldo Website LLC. All rights reserved
                </p>
              </div>
            </div>
          </div>
