          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[920px] rounded border bg-white px-6 py-10 dark:border-transparent dark:bg-[#1D232D] sm:p-[70px]">
                <h3 className="text-black mb-3 font-heading text-2xl font-medium dark:text-white sm:text-3xl lg:text-2xl xl:text-[40px] xl:leading-tight">
                  Client portal sign in
                </h3>
                <p className="mb-12 text-base font-medium text-dark-text">
                  Access project updates, timelines, and shared files.
                </p>
                ...
                <div className="mb-12 flex items-center space-x-4">
                  <button className="flex h-[50px] w-[50px] items-center justify-center rounded border text-base text-dark-text dark:border-transparent dark:bg-[#2C3443] sm:w-auto sm:px-7">
                    ...
                    <span className="hidden sm:inline-flex">Sign in with Google</span>
                  </button>
                ...
                <div className="relative z-10 mb-8 flex items-center justify-center">
                  <span className="bg-slate-300 absolute left-0 top-1/2 -z-10 hidden h-[1px] w-full -translate-y-1/2 dark:bg-[#2E333D] sm:block"></span>
                ...
                <form>
                  <div className="flex flex-wrap -mx-4">
                    <div className="w-full px-4 sm:w-1/2">
                      <div className="mb-10">
                        <label htmlFor="email" className="mb-3 block font-heading text-base text-dark dark:text-white">
                          Email Address
                        </label>
                        <input
                          type="email"
                          name="email"
                          placeholder="hello@aldowebsite.com"
                    ...
                    <div className="w-full px-4 sm:w-1/2">
                      <div className="mb-10">
                        <label htmlFor="password" className="mb-3 block font-heading text-base text-dark dark:text-white">
                          Password
                        </label>
                        <input
                          type="password"
                    ...
                    <div className="w-full px-4">
                      <div className="flex flex-wrap">
                        ...
                        <div className="mb-8">
                          <Link to="/#support" className="text-base text-dark-text hover:text-primary">
                ...
                <p className="mt-8 text-base text-dark-text">
                  ...
                  <Link to="/signup" className="font-medium text-dark hover:text-primary dark:text-white">
                    Request an account
                  </Link>
                </p>
              </div>
