          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[920px] rounded border bg-white py-10 px-6 dark:border-transparent dark:bg-[#1D232D] sm:p-[70px]">
                <h3 className="mb-3 font-heading text-2xl font-medium text-black dark:text-white sm:text-3xl lg:text-2xl xl:text-[40px] xl:leading-tight">
                  Create your client account
                </h3>
                <p className="mb-12 text-base font-medium text-dark-text">
                  Set up access to project updates, shared files, and invoices.
                </p>

                <h3 className="mb-8 text-xl font-heading text-dark dark:text-white">Continue with</h3>
                ...
                <p className="mt-8 text-base text-dark-text">
                  Already have access?{" "}
                  <Link to="/signin" className="font-medium text-dark hover:text-primary dark:text-white">
                    Sign in here
                  </Link>
                </p>
              </div>
