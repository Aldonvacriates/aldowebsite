<section className="pt-[130px]">
      <div className="wow fadeInUp relative z-10 bg-cover bg-center bg-no-repeat py-20 lg:py-[120px]" data-wow-delay=".2s" style="background-image: url(&quot;./images/blog/blog-details.jpg&quot;)">
        <div className="absolute top-0 left-0 z-10 w-full h-full bg-center bg-cover opacity-20 mix-blend-overlay" style="background-image: url(&quot;./images/blog/NoisePatern.svg&quot;)"></div>
        ...
        <div className="px-4 xl:container">
          <div className="mx-auto max-w-[580px] text-center">
            <h1 className="mb-8 font-heading text-3xl font-semibold text-dark dark:text-white md:text-[44px] md:leading-tight">9 simple ways to improve your design skills</h1>
            <div className="flex flex-wrap items-center justify-center -mx-5">
              <div className="flex items-center px-5">
                ...
                <p className="text-base font-heading text-dark-text dark:text-white">Musharof Chy</p>
              </div>
              <div className="flex items-center px-5">
        ...
        <div className="border-b pb-20 dark:border-[#2E333D] lg:pb-[130px]">
          <div className="wow fadeInUp mx-auto max-w-[920px]" data-wow-delay=".2s">
            <p className="text-base mb-9 text-dark-text">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum quis ligula in libero semper ornare. Donec in dictum justo, ac sollicitudin ex. Interdum et malesuada fames ac ante
              ipsum primis in faucibus. In sit amet dui sapien. Suspendisse fermentum nibh a ligula tristique, id vulputate mi efficitur.
            </p>
            <p className="mb-12 text-base text-dark-text">
              Maecenas porta nisi eget urna cursus lobortis. Cras volutpat elit nec quam dignissim semper. Quisque quis fringilla tellus. Phasellus mollis porta urna, eu convallis risus tincidunt
              facilisis. Morbi sit amet nunc tristique, aliquet lectus vestibulum, elementum enim. In sit amet accumsan lectus, ut semper ex. Duis ultrices rutrum odio bibendum aliquam. Nullam posuere
              tristique magna euismod convallis. Aenean dictum neque in ante cursus mollis in tempus elit semper sed.
            </p>
          </div>
          <div className="wow fadeInUp mx-auto mb-12 max-w-[1150px]" data-wow-delay=".2s">
            <img src="/images/blog/blog-details-2.jpg" alt="blog-details" className="w-full rounded" />
          </div>
          <div className="wow fadeInUp mx-auto max-w-[920px]" data-wow-delay=".2s">
            <div className="relative mx-auto max-w-[850px] pt-12 pb-20">
              ...
              <p className="mb-5 text-lg text-center font-heading text-dark-text">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum quis ligula in libero semper ornare. Donec in dictum justo, ac sollicitudin ex.
              </p>
              <p className="text-base text-center font-heading text-dark-text">“Devid Miller”</p>
            </div>
            <p className="text-base mb-9 text-dark-text">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum quis ligula in libero semper ornare. Donec in dictum justo, ac sollicitudin ex. Interdum et malesuada fames ac ante
              ipsum primis in faucibus. In sit amet dui sapien. Suspendisse fermentum nibh a ligula tristique, id vulputate mi efficitur.
          ...
          <div className="wow fadeInUp mx-auto max-w-[920px]" data-wow-delay=".2s">
            <h3 className="mb-14 font-heading text-3xl font-medium text-dark dark:text-white md:text-[40px]">Leave a comment</h3>
            <form>
              <div className="flex flex-wrap -mx-4">
                ...
                <div className="w-full px-4">
                  <button className="flex items-center justify-center rounded bg-primary py-[14px] px-8 font-heading text-base text-white hover:bg-opacity-90">Submit Comment</button>
                </div>
              </div>
            </form>
          </div>
