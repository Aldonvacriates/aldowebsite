<section id="blog" className="pt-[240px]">
      <div className="px-4 xl:container">
        <div className="w-full border-b pb-20 dark:border-[#2E333D]">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div className="mb-10 wow fadeInUp" data-wow-delay=".2s">
                <div className="relative mb-8 overflow-hidden rounded">
                  ...
                  <span className="absolute top-5 left-5 rounded bg-primary py-[6px] px-4 font-heading text-sm font-medium text-white"> Online Business </span>
                </div>
                <div>
          ...
          <div className="flex items-center justify-center pt-10 wow fadeInUp" data-wow-delay=".2s">
            <ul className="-mx-1 flex items-center sm:-mx-[6px]">
              <li className="px-1 sm:px-[6px]">
                <a href="javascript:void(0)" className="flex h-9 items-center justify-center rounded bg-[#2C3443] py-2 px-3 text-base font-medium text-white hover:bg-primary sm:h-10 sm:px-4">
                  <span>
              ...
              <li className="px-1 sm:px-[6px]">
                <a href="javascript:void(0)" className="flex h-9 items-center justify-center rounded bg-[#2C3443] py-2 px-3 text-base font-medium text-white hover:bg-primary sm:h-10 sm:px-4"> 1 </a>
              </li>
              <li className="px-1 sm:px-[6px]">
                <a href="javascript:void(0)" className="flex h-9 items-center justify-center rounded bg-[#2C3443] py-2 px-3 text-base font-medium text-white hover:bg-primary sm:h-10 sm:px-4"> 2 </a>
              </li>
              <li className="px-1 sm:px-[6px]">
                <a href="javascript:void(0)" className="flex h-9 items-center justify-center rounded bg-[#2C3443] py-2 px-3 text-base font-medium text-white hover:bg-primary sm:h-10 sm:px-4"> 3 </a>
              </li>
              <li className="px-1 sm:px-[6px]">
                <a href="javascript:void(0)" className="flex h-9 items-center justify-center rounded bg-[#2C3443] py-2 px-3 text-base font-medium text-white hover:bg-primary sm:h-10 sm:px-4"> 4 </a>
              </li>
              <li className="px-1 sm:px-[6px]">
                <a href="javascript:void(0)" className="flex h-9 items-center justify-center rounded bg-[#2C3443] py-2 px-3 text-base font-medium text-white hover:bg-primary sm:h-10 sm:px-4">
                  <span>
