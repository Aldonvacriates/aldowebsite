<footer className="wow fadeInUp pt-14 sm:pt-20 lg:pt-[130px]" data-wow-delay=".2s">
      <div className="px-4 xl:container">
        <div className="flex flex-wrap -mx-4">
          <div className="w-full px-4 sm:w-1/2 md:w-5/12 lg:w-3/12 xl:w-3/12">
            <div className="mb-20 max-w-[330px]">
              <a href="index.html" className="inline-block mb-6">
                <img src="/images/logo/logo-dark.svg" alt="logo" className="hidden h-[50px] dark:block" />
                <img src="/images/logo/logo-light.svg" alt="logo" className="h-[50px] dark:hidden" />
              </a>

              <p className="mb-10 text-base text-dark-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          ...
          <div className="w-1/2 px-4 md:w-3/12 lg:w-3/12 xl:w-2/12">
            <div className="mb-20">
              <h3 className="text-2xl font-medium mb-9 font-heading text-dark dark:text-white">Company</h3>

              <ul className="space-y-4">
                <li>
                  <a href="javascript:void(0)" className="text-base font-heading text-dark-text hover:text-primary dark:hover:text-white"> Home </a>
                </li>
                <li>
                  <a href="javascript:void(0)" className="text-base font-heading text-dark-text hover:text-primary dark:hover:text-white"> Product </a>
                </li>
                <li>
                  <a href="javascript:void(0)" className="text-base font-heading text-dark-text hover:text-primary dark:hover:text-white">
                    Careers
                    <span className="px-2 py-1 ml-4 text-xs text-white rounded bg-primary font-heading"> Hiring </span>
                  </a>
                </li>
                <li>
                  <a href="javascript:void(0)" className="text-base font-heading text-dark-text hover:text-primary dark:hover:text-white"> Pricing </a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="w-1/2 px-4 md:w-3/12 lg:w-3/12 xl:w-2/12">
            <div className="mb-20">
              <h3 className="text-2xl font-medium mb-9 font-heading text-dark dark:text-white">Support</h3>

              <ul className="space-y-4">
                <li>
                  <a href="javascript:void(0)" className="text-base font-heading text-dark-text hover:text-primary dark:hover:text-white"> Company </a>
                </li>
                <li>
                  <a href="javascript:void(0)" className="text-base font-heading text-dark-text hover:text-primary dark:hover:text-white"> Press media </a>
                </li>
                <li>
                  <a href="javascript:void(0)" className="text-base font-heading text-dark-text hover:text-primary dark:hover:text-white"> Our Blog </a>
                </li>
                <li>
                  <a href="javascript:void(0)" className="text-base font-heading text-dark-text hover:text-primary dark:hover:text-white"> Contact Us </a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-5/12 lg:w-3/12 xl:w-2/12">
            <div className="mb-20">
              <h3 className="text-2xl font-medium mb-9 font-heading text-dark dark:text-white">Get in touch</h3>

              <div className="space-y-7">
                <div>
                  <p className="text-base font-heading text-dark-text">Toll Free Customer Care</p>
                  <a href="tel:+(1) 123 456 7890" className="text-base font-heading text-dark hover:text-primary dark:text-white dark:hover:text-primary"> +(1) 385 238 5172 </a>
                </div>
                <div>
                  <p className="text-base font-heading text-dark-text">Need live support?</p>
                  <a href="mailto:support@domain.com" className="text-base font-heading text-dark hover:text-primary dark:text-white dark:hover:text-primary"> support@domain.com </a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-5/12 lg:w-5/12 xl:w-3/12">
            <div className="mb-20">
              <h3 className="text-2xl font-medium mb-9 font-heading text-dark dark:text-white">Newsletter</h3>
              <p className="mb-6 text-base font-heading text-dark-text">Subscribe to receive future updates</p>
        ...
        <div className="dark:border-[#2E333D] md:border-t">
          <div className="flex flex-wrap py-5 -mx-4 md:py-7">
            <div className="w-full px-4 md:w-1/2 lg:w-2/3">
              <div className="mb-5 flex items-center justify-center space-x-5 border-b pb-5 dark:border-[#2E333D] md:mb-0 md:justify-start md:border-0 md:pb-0">
                <a href="javascript:void(0)" className="text-base font-heading text-dark-text hover:text-primary"> English </a>
                <a href="javascript:void(0)" className="text-base font-heading text-dark-text hover:text-primary"> Privacy Policy </a>
                <a href="javascript:void(0)" className="text-base font-heading text-dark-text hover:text-primary"> Support </a>
              </div>
            </div>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div>
                <p className="text-base text-center font-heading text-dark-text lg:text-right">© 2025 Aldo Website LLC. All rights reserved</p>
              </div>
            </div>
          </div>
        </div>
