<section id="home" className="relative z-40 overflow-hidden pt-28 pb-24 sm:pt-36 lg:pt-[170px] lg:pb-[120px]">
        ...
        <div className="flex flex-wrap items-center -mx-4">
          <div className="w-full px-3 lg:w-1/2">
            <div className="mx-auto mb-12 max-w-[530px] text-center lg:ml-0 lg:mb-0 lg:text-left">
              ...
              <h1 className="wow fadeInUp mb-5 font-heading text-2xl font-semibold dark:text-white sm:text-4xl md:text-[50px] md:leading-[60px]" data-wow-delay=".3s">
                Digital Solutions for <br>Your
                
                <span className="underline txt-type" data-wait="3000" data-words='["Business", "E-commerce", "SaaS", "Brand"]'></span>
              </h1>
              <p className="mb-12 text-base wow fadeInUp text-dark-text" data-wow-delay=".4s">
                We design and build conversion-focused websites, e-commerce systems, and automated digital platforms that help small businesses grow revenue and save 5–15 hours per week in manual work.
              </p>
              <div className="flex flex-wrap items-center justify-center wow fadeInUp lg:justify-start" data-wow-delay=".5s">
                <a href="#features" className="inline-flex items-center rounded bg-primary py-[10px] px-6 font-heading text-base text-white hover:bg-opacity-90 md:py-[14px] md:px-8">
                  Get Started
                  <span className="pl-3">
                ...
                <a href="#about" className="inline-flex items-center rounded py-[14px] px-8 font-heading text-base text-dark hover:text-primary dark:text-white dark:hover:text-primary">
                  <span className="pr-3">
          ...
          <div className="w-full px-4 lg:w-1/2">
            <div className="wow fadeInRight relative z-30 mx-auto h-[560px] w-full max-w-[700px] lg:ml-0" data-wow-delay=".3s">
    ...
    <section id="features" className="pt-14 sm:pt-20 lg:pt-[130px]">
      <div className="px-4 xl:container">
        ...
        <div className="wow fadeInUp relative mx-auto mb-12 max-w-[620px] pt-6 text-center md:mb-20 lg:pt-16" data-wow-delay=".2s">
          ...
          <h2 className="mb-5 font-heading text-3xl font-semibold text-dark dark:text-white sm:text-4xl md:text-[50px] md:leading-[60px]">What We Build (and Why It Works)</h2>
          <p className="text-base text-dark-text">We focus on outcomes: more qualified leads, smoother operations, and systems that scale without breaking.</p>
        </div>
        ...
        <div className="flex flex-wrap justify-center -mx-4">
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="wow fadeInUp group mx-auto mb-10 max-w-[380px] text-center md:mb-16" data-wow-delay=".2s">
              ...
              <div>
                <h3 className="mb-3 text-xl font-medium font-heading text-dark dark:text-white sm:text-2xl md:mb-5">Crafted for Startups</h3>
                <p className="text-base text-dark-text">Connect your forms, calendars, email, and CRM to reduce manual admin work and keep leads moving.</p>
              </div>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="wow fadeInUp group mx-auto mb-10 max-w-[380px] text-center md:mb-16" data-wow-delay=".25s">
              ...
              <div>
                <h3 className="mb-3 text-xl font-medium font-heading text-dark dark:text-white sm:text-2xl md:mb-5">High-quality Design</h3>
                <p className="text-base text-dark-text">Modern layouts and clear messaging designed to turn visitors into customers—not just “pretty pages.”</p>
              </div>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="wow fadeInUp group mx-auto mb-10 max-w-[380px] text-center md:mb-16" data-wow-delay=".3s">
              ...
              <div>
                <h3 className="mb-3 text-xl font-medium font-heading text-dark dark:text-white sm:text-2xl md:mb-5">All Essential Sections</h3>
                <p className="text-base text-dark-text">Shopify builds and custom stores with product setup, checkout, taxes, and operational workflows.</p>
              </div>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="wow fadeInUp group mx-auto mb-10 max-w-[380px] text-center md:mb-16" data-wow-delay=".35s">
              ...
              <div>
                <h3 className="mb-3 text-xl font-medium font-heading text-dark dark:text-white sm:text-2xl md:mb-5">Speed Optimized</h3>
                <p className="text-base text-dark-text">Fast, accessible experiences optimized for mobile, SEO basics, and Core Web Vitals.</p>
              </div>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="wow fadeInUp group mx-auto mb-10 max-w-[380px] text-center md:mb-16" data-wow-delay=".4s">
              ...
              <div>
                <h3 className="mb-3 text-xl font-medium font-heading text-dark dark:text-white sm:text-2xl md:mb-5">Fully Customizable</h3>
                <p className="text-base text-dark-text">You work directly with me, Aldo—clear timelines, transparent communication, and real accountability.</p>
              </div>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="wow fadeInUp group mx-auto max-w-[380px] text-center md:mb-16" data-wow-delay=".45s">
              ...
              <div>
                <h3 className="mb-3 text-xl font-medium font-heading text-dark dark:text-white sm:text-2xl md:mb-5">Automation & Integrations</h3>
                <p className="text-base text-dark-text">Build once, scale later: clean code and systems that can evolve into subscriptions or SaaS features.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="about" className="pt-14 sm:pt-20 lg:pt-[130px]">
      <div className="px-4 xl:container">
        ...
        <div className="relative pt-6 mx-auto mb-12 text-center wow fadeInUp lg:mb-20 lg:pt-16" data-wow-delay=".2s">
          <span className="title"> ABOUT US </span>
          <h2 className="mx-auto mb-5 max-w-[570px] font-heading text-3xl font-semibold text-dark dark:text-white sm:text-4xl md:text-[50px] md:leading-[60px]">Built for Small Businesses That Want Real Results</h2>
          <p className="mx-auto max-w-[570px] text-base text-dark-text">
            We focus on outcomes: more qualified leads, smoother operations, and systems that scale without breaking.
          </p>
        </div>

        <div className="wow fadeInUp relative z-10 overflow-hidden rounded px-8 pt-0 pb-8 md:px-[70px] md:pb-[70px] lg:px-[60px] lg:pb-[60px] xl:px-[70px] xl:pb-[70px]" data-wow-delay=".3s">
              ...
              <div className="-mx-4 w-full flex flex-wrap items-center pt-[70px]">
                <div className="w-full px-4 lg:w-1/2">
                  <div className="relative z-30 mb-14 h-[490px] max-w-[600px] lg:mb-0">
                    ...
                    <div className="absolute right-0 z-10 -translate-y-1/2 top-1/2">
                      ...
                      <div
                        className="absolute -left-5 -top-5 -z-10 h-full w-full border border-primary border-opacity-10 bg-primary bg-opacity-5 backdrop-blur-[6px] dark:border-white dark:border-opacity-10 dark:bg-white dark:bg-opacity-10"
                      ></div>
                    </div>
                ...
                <div className="w-full px-4 lg:w-1/2">
                  <div className="max-w-[565px] lg:ml-auto">
                    <h2 className="mb-8 font-heading text-2xl font-bold text-dark dark:text-white sm:text-[40px] sm:leading-[50px]">We are Creative Digital Agency Based in USA</h2>
                    ...
                    <p className="mb-6 text-base text-dark-text">Phasellus ex massa, facilisis ac vestibulum eget, ultrices quis nulla. Integer vitae magna lacus. Sed venenatis auctor dolor.</p>
                    <p className="text-base text-dark-text">Phasellus ex massa, facilisis ac vestibulum eget, ultrices quis nulla. Integer vitae magna lacus. Sed venenatis auctor dolor.</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <section id="team" className="pt-14 sm:pt-20 lg:pt-[130px]">
      <div className="px-4 xl:container">
        ...
        <div className="relative pt-6 mx-auto mb-12 text-center wow fadeInUp md:mb-20 lg:pt-16" data-wow-delay=".2s">
          <span className="title"> OUR TEAM </span>
          <h2 className="mx-auto mb-5 max-w-[620px] font-heading text-3xl font-semibold text-dark dark:text-white sm:text-4xl md:text-[50px] md:leading-[60px]">Meet With Our Creative Dedicated Team</h2>
        ...
        <div className="flex flex-wrap justify-center -mx-4">
          <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            <div className="wow fadeInUp group mx-auto mb-10 max-w-[300px] text-center xs:max-w-[370px]" data-wow-delay=".2s">
              <div className="relative mb-8 overflow-hidden rounded">
                <img src="/images/team/image-1.jpg" alt="team-image" className="w-full" />
              ...
              <div>
                <h3 className="mb-1 text-xl font-medium font-heading text-dark dark:text-white sm:text-2xl">Olivia Andrium</h3>
                <p className="text-base font-heading text-dark-text">Project Manager</p>
              </div>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            <div className="wow fadeInUp group mx-auto mb-10 max-w-[300px] text-center xs:max-w-[370px]" data-wow-delay=".25s">
              <div className="relative mb-8 overflow-hidden rounded">
                <img src="/images/team/image-2.jpg" alt="team-image" className="w-full" />
                <div className="absolute transition duration-300 -translate-x-1/2 translate-y-10 opacity-0 bottom-6 left-1/2 group-hover:translate-y-0 group-hover:opacity-100">
                  <div className="flex items-center justify-center space-x-3">
                    <a
                      href="javascript:void(0)"
              ...
              <div>
                <h3 className="mb-1 text-xl font-medium font-heading text-dark dark:text-white sm:text-2xl">Jemse Kemorun</h3>
                <p className="text-base font-heading text-dark-text">Project Designer</p>
              </div>
            </div>
          </div>
          <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            <div className="wow fadeInUp group mx-auto mb-10 max-w-[300px] text-center xs:max-w-[370px]" data-wow-delay=".3s">
              <div className="relative mb-8 overflow-hidden rounded">
                <img src="/images/team/image-3.jpg" alt="team-image" className="w-full" />
                <div className="absolute transition duration-300 -translate-x-1/2 translate-y-10 opacity-0 bottom-6 left-1/2 group-hover:translate-y-0 group-hover:opacity-100">
                  <div className="flex items-center justify-center space-x-3">
                    <a
                      href="javascript:void(0)"
              ...
              <div>
                <h3 className="mb-1 text-xl font-medium font-heading text-dark dark:text-white sm:text-2xl">E‑Commerce Founder</h3>
                <p className="text-base font-heading text-dark-text">United States</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="portfolio" className="pt-14 sm:pt-20 lg:pt-[130px]">
      <div className="px-4 xl:container">
        ...
        <div className="relative pt-6 mx-auto mb-12 text-center wow fadeInUp md:mb-20 lg:pt-16" data-wow-delay=".2s">
          ...
          <h2 className="mx-auto mb-5 max-w-[500px] font-heading text-3xl font-semibold text-dark dark:text-white sm:text-4xl md:text-[50px] md:leading-[60px]">Selected Work (New Projects Added Regularly)</h2>
          <p className="mx-auto max-w-[620px] text-base text-dark-text">
            We focus on outcomes: more qualified leads, smoother operations, and systems that scale without breaking.
          </p>
        </div>
        ...
        <div className="w-full">
          <div className="flex items-center justify-center pb-2 mb-16 overflow-x-auto portfolio-btn-wrapper wow fadeInUp" data-wow-delay=".2s">
            <button className="px-5 text-base active whitespace-nowrap font-heading text-dark dark:text-white" data-filter="*">All</button>
            <button className="px-5 text-base whitespace-nowrap font-heading text-dark dark:text-white" data-filter=".branding">Branding Strategy</button>
            <button className="px-5 text-base whitespace-nowrap font-heading text-dark dark:text-white" data-filter=".digital">Digital Experiences</button>
            <button className="px-5 text-base whitespace-nowrap font-heading text-dark dark:text-white" data-filter=".ecom">eCommerce</button>
          </div>

          <div className="flex flex-wrap -mx-4 portfolio-grid">
            <div className="grid-sizer"></div>
            <div className="w-full px-4 grid-item ecom lg:w-2/3">
              <div className="relative mb-10 overflow-hidden rounded wow fadeInUp group" data-wow-delay=".2s">
                <img src="/images/portfolio/image-1.jpg" alt="portfolio-image" className="w-full" />

                <div
                  className="duration-300 absolute bottom-8 left-5 flex translate-y-8 items-center justify-between rounded bg-[#000] bg-opacity-30 py-5 px-4 opacity-0 backdrop-blur-[30px] transition group-hover:translate-y-0 group-hover:opacity-100 sm:left-8 sm:px-6 lg:left-5 lg:px-4 xl:px-6 2xl:left-8"
                >
                  <div className="border-r border-[#e9e9e9] border-opacity-30 pr-4 sm:pr-5 lg:pr-4 xl:pr-5">
                    <h3 className="text-base font-medium text-white font-heading sm:text-xl lg:text-base xl:text-xl">Photo Retouching</h3>
                    <p className="text-sm text-[#d9d9d9] sm:text-base lg:text-sm xl:text-base">Branded Ecommerce</p>
                  </div>
            ...
            <div className="w-full px-4 grid-item branding md:w-1/2 lg:w-1/3">
              <div className="relative mb-10 overflow-hidden rounded wow fadeInUp group" data-wow-delay=".25s">
                <img src="/images/portfolio/image-2.jpg" alt="portfolio-image" className="w-full" />
            ...
            <div className="w-full px-4 grid-item digital md:w-1/2 lg:w-1/3">
              <div className="relative mb-10 overflow-hidden rounded wow fadeInUp group" data-wow-delay=".3s">
                <img src="/images/portfolio/image-3.jpg" alt="portfolio-image" className="w-full" />
            ...
            <div className="w-full px-4 grid-item ecom md:w-1/2 lg:w-1/3">
              <div className="relative mb-10 overflow-hidden rounded wow fadeInUp group" data-wow-delay=".35s">
                <img src="/images/portfolio/image-4.jpg" alt="portfolio-image" className="w-full" />
          ...
          <div className="w-full pt-10 text-center wow fadeInUp" data-wow-delay=".2s">
            <a href="javascript:void(0)" className="inline-flex items-center rounded bg-primary py-[14px] px-8 font-heading text-base text-white hover:bg-opacity-90">
              See More Projects
              <span className="pl-3">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12.172 7L6.808 1.636L8.222 0.222L16 8L8.222 15.778L6.808 14.364L12.172 9H0V7H12.172Z" fill="white" />
    ...
    <section id="testimonial" className="pt-14 sm:pt-20 lg:pt-[130px]">
      <div className="px-4 xl:container">
        ...
        <div className="relative pt-6 mx-auto mb-12 text-center wow fadeInUp md:mb-20 lg:pt-16" data-wow-delay=".2s">
          ...
          <h2 className="mx-auto mb-5 max-w-[450px] font-heading text-3xl font-semibold text-dark dark:text-white sm:text-4xl md:text-[50px] md:leading-[60px]">What Working With Us Feels Like</h2>
          <p className="mx-auto max-w-[620px] text-base text-dark-text">
            We focus on outcomes: more qualified leads, smoother operations, and systems that scale without breaking.
          </p>
        </div>
                  ...
                  <div className="order-last w-full px-4 lg:order-first lg:w-1/2">
                    <div className="text-center lg:text-left">
                      <p className="text-base font-light mb-9 font-heading text-dark-text lg:text-lg xl:text-2xl">
                        “The process was straightforward and the site finally matched our brand. We started getting better inquiries and spent less time chasing details.”
                      </p>

                      <h3 className="mb-1 text-xl font-heading text-dark dark:text-white">Local Service Business Owner</h3>
                      <p className="text-base text-dark-text">Utah, USA</p>
                    </div>
                  </div>
                  <div className="w-full px-4 lg:w-1/2">
                    <div className="lg:mr-0 relative mx-auto mb-9 h-[420px] w-full max-w-[420px] lg:mb-0">
                      <div className="absolute z-10 right-5 top-5">
                        <img src="/images/testimonial/image-1.jpg" alt="testimonial-image" />
                        <div
                          className="absolute -right-5 -top-5 -z-10 h-full w-full border border-primary border-opacity-10 bg-primary bg-opacity-5 backdrop-blur-[6px] dark:border-white dark:border-opacity-10 dark:bg-white dark:bg-opacity-10"
                        ></div>
                      </div>
              ...
              <div className="testimonial-item">
                <div className="flex flex-wrap items-center -mx-4">
                  <div className="order-last w-full px-4 lg:order-first lg:w-1/2">
                    <div className="text-center lg:text-left">
                      <p className="text-base font-light mb-9 font-heading text-dark-text lg:text-lg xl:text-2xl">
                        “We went from scattered tools to a clean system. Orders and follow-ups became easier, and customers had a smoother experience.” Fusce condimentum sapien ac leo cursus dignissim. In ac lectus vel orci accumsan ultricies at in libero accumsan Lorem
    ...
    <section className="pt-14 sm:pt-20 lg:pt-24">
      <div className="px-4 xl:container">
        ...
        <div className="wow fadeInUp relative mx-auto mb-16 max-w-[620px] text-center" data-wow-delay=".2s">
          <h2 className="mb-5 font-heading text-[38px] font-semibold leading-tight text-dark dark:text-white">Trusted by Global Brands</h2>
          <p className="text-base text-dark-text">We focus on outcomes: more qualified leads, smoother operations, and systems that scale without breaking.</p>
        </div>
        <div className="border-b pb-24 dark:border-[#2E333D]">
          <div className="flex flex-wrap -mx-4 wow fadeInUp" data-wow-delay=".2s">
            <div className="w-full px-4">
              <div className="flex flex-wrap items-center justify-center">
                <a href="javascript:void(0)" className="mx-4 flex w-[150px] items-center justify-center py-5 2xl:w-[180px]">
                  <img src="/images/brands/uideck.svg" alt="image" className="hidden w-full h-10 dark:block" />
                  <img src="/images/brands/uideck-2.svg" alt="image" className="w-full h-10 dark:hidden" />
                </a>
                <a href="javascript:void(0)" className="mx-4 flex w-[150px] items-center justify-center py-5 2xl:w-[180px]">
                  <img src="/images/brands/tailadmin.svg" alt="image" className="hidden w-full h-10 dark:block" />
                  <img src="/images/brands/tailadmin-2.svg" alt="image" className="w-full h-10 dark:hidden" />
                </a>
                <a href="javascript:void(0)" className="mx-4 flex w-[150px] items-center justify-center py-5 2xl:w-[180px]">
                  <img src="/images/brands/graygrids.svg" alt="image" className="hidden w-full h-10 dark:block" />
                  <img src="/images/brands/graygrids-2.svg" alt="image" className="w-full h-10 dark:hidden" />
                </a>
                <a href="javascript:void(0)" className="mx-4 flex w-[150px] items-center justify-center py-5 2xl:w-[180px]">
                  <img src="/images/brands/lineicons.svg" alt="image" className="hidden w-full h-10 dark:block" />
                  <img src="/images/brands/lineicons-2.svg" alt="image" className="w-full h-10 dark:hidden" />
                </a>
                <a href="javascript:void(0)" className="mx-4 flex w-[150px] items-center justify-center py-5 2xl:w-[180px]">
                  <img src="/images/brands/plainadmin.svg" alt="image" className="hidden w-full h-10 dark:block" />
                  <img src="/images/brands/plainadmin-2.svg" alt="image" className="w-full h-10 dark:hidden" />
                </a>
              </div>
            </div>
          </div>
    ...
    <section id="pricing" className="pt-14 sm:pt-20 lg:pt-[130px]">
      <div className="px-4 xl:container">
        ...
        <div className="relative w-full pt-10 mb-12 text-center wow fadeInUp md:mb-20 lg:pt-16" data-wow-delay=".2s">
          <span className="title whitespace-nowrap"> PRICING PLANS </span>
          <h2 className="mx-auto mb-5 max-w-[600px] font-heading text-3xl font-semibold text-dark dark:text-white sm:text-4xl md:text-[50px] md:leading-[60px]">Straightforward Packages (Project + Optional Monthly Support)</h2>
        ...
        <div className="relative z-10 flex flex-wrap justify-center overflow-hidden rounded drop-shadow-light dark:drop-shadow-none">
          ...
          <div className="w-full sm:w-1/2 lg:w-1/3">
            <div className="pt-10 pb-20 text-center wow fadeInUp" data-wow-delay=".2s">
              <div className="border-b dark:border-[#2E333D]">
                <h3 className="mb-2 text-3xl font-medium font-heading text-dark dark:text-white">Starter Site</h3>
                <p className="pb-10 text-base text-dark-text">The most basic plan</p>
              </div>
              <div className="border-b py-10 dark:border-[#2E333D]">
                ...
                <p className="mx-auto max-w-[300px] text-base text-dark-text">Lorem ipsum dolor sit ametion consectetur adipisc elit.</p>
              </div>
              <div className="space-y-4 px-6 pt-10 pb-[60px] text-left sm:px-10 md:px-8 lg:px-10 xl:px-20">
                ...
                <p className="flex items-center text-base text-dark-text">
                  ...
                  Content & Assets Support and Videos
                </p>
                <p className="flex items-center text-base text-dark-text">
                  <span className="inline-block pr-2 text-[#00CB99]">
                    <svg width="24" height="24" viewBox="0 0 24 24" className="fill-current">
              ...
              <a href="javascript:void(0)" className="inline-flex items-center rounded bg-dark-text py-[14px] px-8 font-heading text-base text-white hover:bg-primary">
                Request a Quote
                <span className="pl-3">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.172 7L6.808 1.636L8.222 0.222L16 8L8.222 15.778L6.808 14.364L12.172 9H0V7H12.172Z" fill="white" />
          ...
          <div className="w-full dark:border-[#2E333D] sm:w-1/2 sm:border-l lg:w-1/3 lg:border-x">
            <div className="pt-10 pb-20 text-center wow fadeInUp" data-wow-delay=".3s">
              <div className="border-b dark:border-[#2E333D]">
                <h3 className="mb-2 text-3xl font-medium font-heading text-dark dark:text-white">Growth (E‑Commerce)</h3>
                <p className="pb-10 text-base text-dark-text">The most popular plan</p>
              </div>
              <div className="border-b py-10 dark:border-[#2E333D]">
                <h3 className="flex items-end justify-center pt-2 mb-6 text-base font-medium font-heading text-dark dark:text-white">
          ...
          <div className="w-full sm:w-1/2 lg:w-1/3">
            <div className="pt-10 pb-20 text-center wow fadeInUp" data-wow-delay=".4s">
              <div className="border-b dark:border-[#2E333D]">
                <h3 className="mb-2 text-3xl font-medium font-heading text-dark dark:text-white">Scale (Custom / SaaS)</h3>
                <p className="pb-10 text-base text-dark-text">The most premium plan</p>
              </div>
              <div className="border-b py-10 dark:border-[#2E333D]">
                <h3 className="flex items-end justify-center pt-2 mb-6 text-base font-medium font-heading text-dark dark:text-white">
        ...
        <div className="pt-12 text-center">
          <h3 className="mb-5 text-xl font-medium font-heading text-dark dark:text-white sm:text-3xl">Need something custom?</h3>
          <p className="text-base text-dark-text">Book a call and I’ll scope the fastest path to results.</p>
        </div>
      </div>
    </section>
    ...
    <section id="blog" className="pt-14 sm:pt-20 lg:pt-[130px]">
      <div className="px-4 xl:container">
        ...
        <div className="wow fadeInUp relative mx-auto mb-12 max-w-[620px] pt-6 text-center md:mb-20 lg:pt-16" data-wow-delay=".2s">
          ...
          <h2 className="mb-5 font-heading text-3xl font-semibold text-dark dark:text-white sm:text-4xl md:text-[50px] md:leading-[60px]">Guides & Resources</h2>
          <p className="text-base text-dark-text">We focus on outcomes: more qualified leads, smoother operations, and systems that scale without breaking.</p>
        </div>
          ...
          <div className="flex flex-wrap -mx-4">
              ...
              <div className="mb-10 wow fadeInUp" data-wow-delay=".2s">
                <div className="relative mb-8 overflow-hidden rounded">
                  <a href="javascript:void(0)" className="block">
                    <img src="/images/blog/image-1.jpg" alt="blog-image" className="w-full" />
                  </a>
                  <span className="absolute top-5 left-5 rounded bg-primary py-[6px] px-4 font-heading text-sm font-medium text-white"> Automation </span>
                </div>
                <div>
                  ...
                  <h3>
                    <a href="javascript:void(0)" className="text-xl font-medium font-heading text-dark hover:text-primary dark:text-white dark:hover:text-primary md:text-2xl lg:text-xl xl:text-2xl">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div className="mb-10 wow fadeInUp" data-wow-delay=".3s">
                <div className="relative mb-8 overflow-hidden rounded">
                  <a href="javascript:void(0)" className="block">
                    <img src="/images/blog/image-2.jpg" alt="blog-image" className="w-full" />
                  </a>
                  <span className="absolute top-5 left-5 rounded bg-primary py-[6px] px-4 font-heading text-sm font-medium text-white"> Ui/Ux Design </span>
                </div>
                <div>
                  <div className="flex items-center mb-4">
                    <p className="flex items-center pr-5 text-base font-heading text-dark-text">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div className="mb-10 wow fadeInUp" data-wow-delay=".4s">
                <div className="relative mb-8 overflow-hidden rounded">
                  <a href="javascript:void(0)" className="block">
                    <img src="/images/blog/image-3.jpg" alt="blog-image" className="w-full" />
                  </a>
                  <span className="absolute top-5 left-5 rounded bg-primary py-[6px] px-4 font-heading text-sm font-medium text-white"> Web Development </span>
                </div>
                <div>
                  <div className="flex items-center mb-4">
                    <p className="flex items-center pr-5 text-base font-heading text-dark-text">
            ...
            <div className="flex flex-wrap items-center border-b pb-14 dark:border-[#2E333D] lg:pb-0">
              <div className="w-full px-4 lg:w-1/2">
                ...
                <div className="wow fadeInUp relative mb-12 max-w-[500px] pt-6 md:mb-14 lg:pt-16" data-wow-delay=".2s">
                  ...
                  <h2 className="mb-5 font-heading text-3xl font-semibold text-dark dark:text-white sm:text-4xl md:text-[50px] md:leading-[60px]">Need Any Help? Say hello</h2>
                  <p className="text-base text-dark-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit Donec vitae tortor aliquam ante.</p>
                </div>
              </div>

              <div className="w-full px-4 lg:w-1/2">
                <div className="flex items-center wow fadeInUp" data-wow-delay=".2s">
                  <span className="mr-10 h-1 w-full max-w-[200px] bg-dark dark:bg-white"></span>
                  <a href="mailto:info@gostartup.com" className="text-xl font-heading text-dark dark:text-white md:text-3xl lg:text-xl xl:text-3xl"> info@gostartup.com </a>
                </div>
              </div>
            </div>

            <div className="flex flex-wrap pt-12 -mx-4 wow fadeInUp" data-wow-delay=".2s">
              <div className="w-full px-4 md:w-1/2 lg:w-1/4">
                <div className="mb-6">
                  <h3 className="mb-2 text-base font-heading text-dark dark:text-white sm:text-xl">Email Address</h3>
                  <p className="text-base font-medium text-dark-text">support@startup.com</p>
                </div>
              </div>
              <div className="w-full px-4 md:w-1/2 lg:w-1/4">
                <div className="mb-6">
                  <h3 className="mb-2 text-base font-heading text-dark dark:text-white sm:text-xl">Phone Number</h3>
                  <p className="text-base font-medium text-dark-text">+009 8754 3433 223</p>
                </div>
              </div>
              <div className="w-full px-4 md:w-1/2 lg:w-1/4">
                <div className="mb-6">
                  <h3 className="mb-2 text-base font-heading text-dark dark:text-white sm:text-xl">Office Location</h3>
                  <p className="text-base font-medium text-dark-text">76/A, Green valle, Califonia USA.</p>
                </div>
              </div>
              <div className="w-full px-4 md:w-1/2 lg:w-1/4">
                <div className="flex items-center mb-6 space-x-5 lg:justify-end">
                  <a href="javascript:void(0)" name="social-link" aria-label="social-link" className="text-dark-text hover:text-primary dark:hover:text-white">
                    <svg width="24" height="24" viewBox="0 0 24 24" className="fill-current">
          ...
          <form className="wow fadeInUp" data-wow-delay=".2s" action="https://formbold.com/s/unique_form_id" method="POST">
            <div className="flex flex-wrap -mx-4">
              <div className="w-full px-4 sm:w-1/2">
                <div className="mb-12">
                  <label htmlFor="name" className="block mb-3 text-base font-heading text-dark dark:text-white"> Your Name </label>
                  <input
                    type="text"
                    name="name"
                    id="name"
              ...
              <div className="w-full px-4 sm:w-1/2">
                <div className="mb-12">
                  <label htmlFor="email" className="block mb-3 text-base font-heading text-dark dark:text-white"> Email Address </label>
                  <input
                    type="email"
                    name="email"
                    id="email"
              ...
              <div className="w-full px-4 sm:w-1/2">
                <div className="mb-12">
                  <label htmlFor="phone" className="block mb-3 text-base font-heading text-dark dark:text-white"> Phone (Optional) </label>
                  <input
                    type="text"
                    name="phone"
                    id="phone"
              ...
              <div className="w-full px-4 sm:w-1/2">
                <div className="mb-12">
                  <label htmlFor="subject" className="block mb-3 text-base font-heading text-dark dark:text-white"> Subject </label>
                  <input
                    type="text"
                    name="subject"
                    id="subject"
              ...
              <div className="w-full px-4">
                <div className="mb-10">
                  <label htmlFor="message" className="block mb-3 text-base font-heading text-dark dark:text-white"> Message </label>
                  <textarea
                    rows="4"
                    name="message"
                    id="message"
              ...
              <div className="w-full px-4">
                <div className="mb-12">
                  <label htmlFor="supportCheckbox" className="flex cursor-pointer select-none text-dark-text hover:text-primary">
              ...
              <div className="w-full px-4">
                <button className="flex w-full items-center justify-center rounded bg-primary py-[14px] px-8 font-heading text-base text-white hover:bg-opacity-90">Send Message</button>
              </div>
            </div>
          </form>
        </div>
    ...
    <section id="cta" className="pt-14 sm:pt-20 lg:pt-[130px]">
      <div className="px-4 xl:container">
        <div className="wow fadeInUp relative overflow-hidden bg-cover bg-center py-[60px] px-10 drop-shadow-light dark:drop-shadow-none sm:px-[70px]" data-wow-delay=".2s">
          <div className="absolute top-0 left-0 w-full h-full bg-center bg-cover -z-10 opacity-10 dark:opacity-40 bg-noise-pattern"></div>
          <div className="absolute bottom-0 -translate-x-1/2 left-1/2 -z-10">
            <svg width="1215" height="259" viewBox="0 0 1215 259" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                <filter id="filter0_f_63_363" x="0" y="-261" width="1215" height="1278" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                  <feFlood flood-opacity="0" result="BackgroundImageFix" />
                  <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
          ...
          <div className="flex flex-wrap items-center -mx-4">
            <div className="w-full px-4 lg:w-2/3">
              <div className="mx-auto mb-10 max-w-[550px] text-center lg:ml-0 lg:mb-0 lg:text-left">
                <h2 className="mb-4 font-heading text-xl font-semibold leading-tight text-dark dark:text-white sm:text-[38px]">Looking for a collaboration? Get Started Today!</h2>
                <p className="text-base text-dark-text">Call now.</p>
              </div>
            </div>
            <div className="w-full px-4 lg:w-1/3">
              <div className="text-center lg:text-right">
                <a href="javascript:void(0)" className="inline-flex items-center rounded bg-primary py-[14px] px-8 font-heading text-base text-white hover:bg-opacity-90"> Get Started Now </a>
              </div>
            </div>
          </div>
        </div>
