        ...
        <div className="border-b pb-20 dark:border-[#2E333D] lg:pb-[130px]">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div
                className="mx-auto max-w-[920px] rounded border bg-white px-6 py-10 dark:border-transparent dark:bg-[#1D232D] sm:p-[70px]"
              >
                <h3
                  className="text-black mb-3 font-heading text-2xl font-medium dark:text-white sm:text-3xl lg:text-2xl xl:text-[40px] xl:leading-tight"
                >
                ...
                >
                  <span
                    className="bg-slate-300 absolute left-0 top-1/2 -z-10 hidden h-[1px] w-full -translate-y-1/2 dark:bg-[#2E333D] sm:block"
                  ></span>
                  <p
                    className="bg-white text-base font-medium text-dark-text dark:bg-[#1D232D] sm:px-4"
                  >
                        ...
                        <div className="mb-8 mr-10">
                          ...
                          >
                            <div className="relative">
                              ...
                              />
                              <div
                                className="box mr-4 mt-1 flex h-5 w-5 items-center justify-center rounded border dark:border-[#414652]"
                              >
