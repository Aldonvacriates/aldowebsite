        ...
        <div className="border-b pb-24 dark:border-[#2E333D]">
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[920px] rounded border bg-white py-10 px-6 dark:border-transparent dark:bg-[#1D232D] sm:p-[70px]">
                <h3 className="mb-3 font-heading text-2xl font-medium text-black dark:text-white sm:text-3xl lg:text-2xl xl:text-[40px] xl:leading-tight">Create your Account</h3>
                <p className="mb-12 text-base font-medium text-dark-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>

                <h3 className="mb-8 text-xl font-heading text-dark dark:text-white">Sign Up with Social Media</h3>
                <div className="flex items-center mb-12 space-x-4">
                  <button className="flex h-[50px] w-[50px] items-center justify-center rounded border text-base text-dark-text dark:border-transparent dark:bg-[#2C3443] sm:w-auto sm:px-7">
                  ...
                  <button className="flex h-[50px] w-[50px] items-center justify-center rounded-md border dark:border-transparent dark:bg-[#2C3443]">
                ...
                <div className="relative z-10 flex items-center justify-center mb-8">
                  <span className="absolute top-1/2 left-0 -z-10 hidden h-[1px] w-full -translate-y-1/2 bg-slate-300 dark:bg-[#2E333D] sm:block"></span>
                  <p className="bg-white text-base font-medium text-dark-text dark:bg-[#1D232D] sm:px-4">Or create account with email</p>
                </div>
                ...
                <form>
                  <div className="flex flex-wrap -mx-4">
                    <div className="w-full px-4 sm:w-1/2">
                      <div className="mb-10">
                        <label htmlFor="name" className="block mb-3 text-base font-heading text-dark dark:text-white"> Full Name </label>
                        <input
                          type="text"
                          name="name"
                    ...
                    <div className="w-full px-4 sm:w-1/2">
                      <div className="mb-10">
                        <label htmlFor="password" className="block mb-3 text-base font-heading text-dark dark:text-white"> Password </label>
                        <input
                          type="password"
                          name="password"
                          placeholder="**********"
                    ...
                    <div className="w-full px-4 sm:w-1/2">
                      <div className="mb-10">
                        <label htmlFor="re-password" className="block mb-3 text-base font-heading text-dark dark:text-white"> Retype Password </label>
                        <input
                          type="password"
                          name="re-password"
                          placeholder="**********"
                    ...
                    <div className="w-full px-4">
                      <div className="mb-8">
                        <label htmlFor="supportCheckbox" className="flex max-w-[425px] cursor-pointer select-none text-dark-text hover:text-primary">
                    ...
                    <div className="w-full px-4">
                      <button className="flex items-center justify-center rounded bg-primary py-[14px] px-14 text-sm font-semibold text-white">Create Account</button>
                    </div>
                  </div>
                </form>
              </div>
